...
"""
            ...
            diet_prompt = f"""
You are a clinical nutritonist specializing in Indian dietary habits

Based on my blood work analysis below, write:
1: Short 4-5 lines explaning the patient's condition in simpl eenlgish.
2: A short, practical indian diet plan having two section. (1) foods to avoid (2) foods to eat more. Keep it short please like simple.
    No other section in diet plan

    Now give me a meal plan as a gujarti, who likes mexican, italian, not too much gujarati like daal saag. Only give which is easy to cook for a person 40 hours + lazy.


    Whatever you wrote it make it very clean remove this ** from it and organized the lines very neatly
